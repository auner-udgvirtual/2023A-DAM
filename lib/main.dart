...
class _EliminarPage extends State<EliminarPage> {
  ...
  Stream<List<Movie>> readMovies() => FirebaseFirestore.instance
      .collection('catalogo')
      .snapshots()
      .map((snapshot) =>
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Image.asset("assets/images/movies_wallpaper.jpg"),
              ),
              const Text("Menú",
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        children: [
          ...
          new Center(
            child: new Text("Bienvenidos al catálogo más grande de películas"),
          ),
          SizedBox(width: 24.0),
          Container(
            width: 200,
